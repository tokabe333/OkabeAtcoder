...
public class Data {
	...
	public long b = 0;
	public int no = 0;
	public Data(int n, long aa, long bb) {
		no = n;
		a = aa;
		b = bb;
	}
...
public class Kyopuro {
	...
	public void Solve() {
		...
		int n = readint();
		var list = new List<Data>(new Data[n]);
		for (int i = 0; i < n; ++i) {
			var (a, b) = readlongt2();
			list[i] = new Data(i + 1, a, b);
		}

		// Comparison<Data> comp = (x, y) => (x.a * y.a * y.b) - (y.a * x.a * x.b); 
		int check(Data x, Data y) {
			long a = (x.a * (y.a + y.b)) - (y.a * (x.a + x.b));
			if (a < 0) return 1;
			if (a == 0) {
