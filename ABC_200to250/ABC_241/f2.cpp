...
struct Unchi {
  public:
    ll x, y, d;
    Unchi() {}
    Unchi(ll xx, ll yy, ll dd) : x(xx), y(yy), d(dd) {}
};
...
int main() {
    ...
    while (que.empty() == false) {
        ...
        if (it != xs[x].end()) {
            ...
            que.push(Unchi(x, *it - 1, d + 1));
            printf("上に行った dx:%lld dy:%lld dd:%lld\n", x, *it - 1, d + 1);
        }
        ...
        if (it != xs[x].begin()) {
            ...
            que.push(Unchi(x, *it + 1, d + 1));
            printf("下に行った dx:%lld dy:%lld dd:%lld\n", x, *it + 1, d + 1);
        }
        ...
        if (it != ys[y].end()) {
            ...
            que.push(Unchi(*it - 1, y, d + 1));
            printf("右に行った dx:%lld dy:%lld dd:%lld\n", *it - 1, y, d + 1);
        }
        ...
        if (it != ys[y].begin()) {
            ...
            for (auto hoge : ys[y])
                cout << hoge << " ";
            cout << endl;
            printf("左に行った dx:%lld dy:%lld dd:%lld\n", *it + 1, y, d + 1);
        }
    }
